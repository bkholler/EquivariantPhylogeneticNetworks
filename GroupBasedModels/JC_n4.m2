...
-- make our map on the smaller subset of coordinates and run MultigradedImplicitization
-- the following code only takes about 30 seconds to run
...
dim(J) == rank jacobian matrix phi
isPrime J
